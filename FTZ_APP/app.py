...
# =====================================================
# LOGGING SETUP (ADDED — NO FUNCTIONAL CHANGE)
# =====================================================
LOG_DIR = "logs"
LOG_FILE = os.path.join(LOG_DIR, "ftz_app_usage_log.xlsx")
...
def log_to_excel(row: dict):
    row["timestamp"] = datetime.now(ZoneInfo("America/New_York")).strftime(
    "%Y-%m-%d %H:%M:%S %Z"
)
...
# =========================================================
# CHATBOT — LOG ONLY UNMATCHED QUESTIONS
# =========================================================
st.markdown("---")
...
if st.button("Ask AI"):
    if user_q.strip():
        ...
        if not response:
            ...
            response = (
                "Thank you for your question, Your question will be directed to"
